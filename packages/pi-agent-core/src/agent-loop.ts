...
import { EventStream } from "@earendil-works/pi-ai/utils/event-stream";
...
async function streamAssistantResponse(
	...
	if (!streamFn) {
		throw new Error("A stream function is required for this browser-compatible agent loop build.");
	}
